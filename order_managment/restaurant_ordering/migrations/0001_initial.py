    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='restaurant_ordering.customer', verbose_name='Клиент')),
            ],
            options={
                'verbose_name': 'Заказ',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='restaurant_ordering.order', verbose_name='id заказа')),
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='restaurant_ordering.menu', verbose_name='Наименование продукта')),
            ],
            options={
